      ...
      <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center min-h-[80vh] p-8">
        ...
        <div className="space-y-6">
          ...
          <p className="text-white/90 leading-relaxed text-lg">
            Ranked <span className="text-accent font-semibold">10th</span> in Civil Engineering at NED University with a CGPA of <span className="text-accent font-semibold">3.782</span>.
